...
public class Player extends IPlayer {
	...
	public Player(RaceType race, String name) {
		super(race, name);
	...
	public void initAnimations() {
		...
		northAnimation.addFrame(race.getSpritesheet().getSubImage(1, 1, 32, 32), 15);
		northAnimation.addFrame(race.getSpritesheet().getSubImage(2, 1, 32, 32), 15);
		northAnimation.addFrame(race.getSpritesheet().getSubImage(1, 1, 32, 32), 15);
		northAnimation.addFrame(race.getSpritesheet().getSubImage(0, 1, 32, 32), 15);
		
		eastAnimation = new Animation();
		eastAnimation.addFrame(race.getSpritesheet().getSubImage(1, 2, 32, 32), 15);
		eastAnimation.addFrame(race.getSpritesheet().getSubImage(2, 2, 32, 32), 15);
		eastAnimation.addFrame(race.getSpritesheet().getSubImage(1, 2, 32, 32), 15);
		eastAnimation.addFrame(race.getSpritesheet().getSubImage(0, 2, 32, 32), 15);

		southAnimation = new Animation();
		southAnimation.addFrame(race.getSpritesheet().getSubImage(1, 0, 32, 32), 15);
		southAnimation.addFrame(race.getSpritesheet().getSubImage(2, 0, 32, 32), 15);
		southAnimation.addFrame(race.getSpritesheet().getSubImage(1, 0, 32, 32), 15);
		southAnimation.addFrame(race.getSpritesheet().getSubImage(0, 0, 32, 32), 15);

		westAnimation = new Animation();
		westAnimation.addFrame(race.getSpritesheet().getSubImage(1, 3, 32, 32), 15);
		westAnimation.addFrame(race.getSpritesheet().getSubImage(2, 3, 32, 32), 15);
		westAnimation.addFrame(race.getSpritesheet().getSubImage(1, 3, 32, 32), 15);
		westAnimation.addFrame(race.getSpritesheet().getSubImage(0, 3, 32, 32), 15);
	}
